...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Guiacompralocal.findAll", query = "SELECT g FROM Guiacompralocal g"),
    @NamedQuery(name = "Guiacompralocal.findByIdguiacompralocal", query = "SELECT g FROM Guiacompralocal g WHERE g.idguiacompralocal = :idguiacompralocal")})
