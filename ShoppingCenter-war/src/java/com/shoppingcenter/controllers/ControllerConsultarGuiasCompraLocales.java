 ...
 * @author AndresPineda
 */
public class ControllerConsultarGuiasCompraLocales implements Serializable {

    AdministrarGestionarGuiasCompraBORemote administrarGestionarGuiasCompraBO = lookupAdministrarGestionarGuiasCompraBORemote();

    private List<GuiaCompraLocal> listaGuiasCompraLocal;

    public ControllerConsultarGuiasCompraLocales() {
    }

    @PostConstruct
    public void init() {
        listaGuiasCompraLocal = administrarGestionarGuiasCompraBO.consultarGuiasCompraLocalRegistradas();
    }

    public List<GuiaCompraLocal> getListaGuiasCompraLocal() {
        return listaGuiasCompraLocal;
    }

    public void setListaGuiasCompraLocal(List<GuiaCompraLocal> listaGuiasCompraLocal) {
        this.listaGuiasCompraLocal = listaGuiasCompraLocal;
    }
