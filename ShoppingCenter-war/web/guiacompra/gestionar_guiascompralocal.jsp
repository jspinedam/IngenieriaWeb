...
<html>
    ...
    <body style="background-image: url('http://www.ucentral.edu.co/images/template_images/ucentral/fondos/fondo_template_default.jpg'); background-repeat: repeat; background-position: 0% 0%; background-attachment: fixed; background-color: #ffffff;">
        <div class="container">
                    ...
                    <fieldset style="border: black;border-radius: 10px;">
                        ...
                        <div class="row">
                            <table border=1 width="100%">
                                ...
                                <jsp:useBean id="guiaController" class="com.shoppingcenter.controllers.ControllerGestionarGuiasCompraLocal" />
                                <%
                                    List<GuiaCompraLocal> listaGuiasCompraLocal = null;
                                    listaGuiasCompraLocal = guiaController.getListaGuiasCompra();
                                    for (int i = 0;
            ...
            <div class="row">
                <div class="col-md-1">
                    <form action="registrarGuiaCompraLocal">
                        <input type="submit" value="Nueva GuiaCompraLocal" class="btn btn-success"/>
                    </form>
                </div>
