...
<html>
    ...
    <body style="background-image: url('http://www.ucentral.edu.co/images/template_images/ucentral/fondos/fondo_template_default.jpg'); background-repeat: repeat; background-position: 0% 0%; background-attachment: fixed; background-color: #ffffff;">
        <% ResourceBundle resource = ResourceBundle.getBundle("i18n.gestionarocalescentrocomercial", request.getLocale());%>
        <div class="container">
            <div class="row">
                <!-- Navigation -->
            ...
            <div class="row">
                <div class="col-md-1">
                    <form action="registrarLocal">
                        <input type="submit" value="<%=resource.getString("nuevoLocal")%>" class="btn btn-success"/>
                    </form>
                </div>
