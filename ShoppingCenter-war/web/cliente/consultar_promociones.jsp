...
<html>
    ...
    <body style="background-image: url('http://www.ucentral.edu.co/images/template_images/ucentral/fondos/fondo_template_default.jpg'); background-repeat: repeat; background-position: 0% 0%; background-attachment: fixed; background-color: #ffffff;">
        <% ResourceBundle resource = ResourceBundle.getBundle("i18n.consultarpromociones", request.getLocale());%>
        <div class="container">
            <div class="row">
                <!-- Navigation -->
                        ...
                        <div class="row">
                            <table border=1 width="100%">
                                <tr>
                                    ...
                                    <th><%=resource.getString("nombreProducto")%></th>
                                    <th><%=resource.getString("codigoProducto")%></th>
                                    <th><%=resource.getString("fechaLimite")%></th>
                                </tr>
